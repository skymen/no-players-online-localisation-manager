...
function testSingleLineSimple() {
  ...
  if (diff.length !== 3) {
    return {
      success: false,
      message: `Expected 3 diff parts, got ${diff.length}`,
    };
  }

  if (
    diff[0].value !== "Hello " ||
    (!diff[0].added === false && !diff[0].removed === false)
  ) {
    return {
      success: false,
      message: "First part should be unchanged 'Hello '",
    };
  }
  ...
  if (diff[1].value !== "beautiful " || !diff[1].added) {
    return {
      success: false,
      message: "Second part should be added 'beautiful '",
    };
  }

  if (
    diff[2].value !== "world" ||
    (!diff[2].added === false && !diff[2].removed === false)
  ) {
    return {
      success: false,
      message: "Third part should be unchanged 'world'",
    };
  }
...
function testSingleLineInsertion() {
  ...
  if (stats.addedWords !== 1 || stats.removedWords !== 0) {
    return {
      success: false,
      message: `Expected 1 added, 0 removed. Got ${stats.addedWords} added, ${stats.removedWords} removed`,
    };
  }
...
function testSingleLineDeletion() {
  ...
  if (stats.addedWords !== 0 || stats.removedWords !== 1) {
    return {
      success: false,
      message: `Expected 0 added, 1 removed. Got ${stats.addedWords} added, ${stats.removedWords} removed`,
    };
  }
...
function testSingleLineNoChange() {
  ...
  if (!identical) {
    return {
      success: false,
      message: "Identical texts should be detected as identical",
    };
  }
...
function testMultilineAddition() {
  ...
  if (stats.addedWords < 1) {
    return {
      success: false,
      message: "Should detect word addition in multiline text",
    };
  }
...
function testMultilineDeletion() {
  ...
  if (stats.removedWords < 1) {
    return {
      success: false,
      message: "Should detect word removal in multiline text",
    };
  }
...
function testMultilineModification() {
  ...
  if (stats.addedWords === 0 && stats.removedWords === 0) {
    return {
      success: false,
      message: "Should detect modifications in multiline text",
    };
  }
...
function testMultilineReorder() {
  ...
  if (diff.length === 0) {
    return {
      success: false,
      message: "Should detect changes in reordered text",
    };
  }
...
New content has been added here.`;
  ...
  if (stats.addedWords === 0 || stats.removedWords === 0) {
    return {
      success: false,
      message: "Complex multiline changes should be detected",
    };
  }
  ...
  if (summary.type === "identical") {
    return {
      success: false,
      message: "Complex changes should not be marked as identical",
    };
  }
...
function testEmptyStrings() {
  ...
  if (stats.totalWords !== 0) {
    return {
      success: false,
      message: "Empty strings should have 0 total words",
    };
  }
...
function testSpecialCharacters() {
  ...
  if (stats.addedWords === 0) {
    return {
      success: false,
      message: "Should detect addition of special characters",
    };
  }
...
function testHTMLContent() {
  ...
  if (htmlDiff.includes("<div>") && !htmlDiff.includes("&lt;")) {
    return {
      success: false,
      message: "HTML content should be escaped in diff output",
    };
  }
...
function testLongText() {
  ...
  const longText2 =
    "This is a very long text. ".repeat(99) + "This is different.";
  ...
  if (processingTime > 1000) {
    return {
      success: false,
      message: `Processing took too long: ${processingTime}ms`,
    };
  }
...
function testStatsCalculation() {
  ...
  if (stats.addedWords !== 2) {
    return {
      success: false,
      message: `Expected 2 added words, got ${stats.addedWords}`,
    };
  }
  ...
  if (stats.removedWords !== 1) {
    return {
      success: false,
      message: `Expected 1 removed word, got ${stats.removedWords}`,
    };
  }
  ...
  if (stats.unchangedWords !== 2) {
    return {
      success: false,
      message: `Expected 2 unchanged words, got ${stats.unchangedWords}`,
    };
  }
...
function testIdentityCheck() {
  ...
  if (areTextsIdentical(text1, text3)) {
    return {
      success: false,
      message: "Different texts should not be detected as identical",
    };
  }
...
function testSummaryGeneration() {
  ...
  if (!summary.type || !summary.message) {
    return {
      success: false,
      message: "Summary should have type and message properties",
    };
  }
